                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="name" class="form-control" id="blogTitle" placeholder="Book Name" value="{{$game->name}}">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="exampleInputPassword1" class="form-label fw-semibold">Game Link</label>
                                    <input type="text" name="link" class="form-control" id="exampleInputtext" value="{{$game->link}}" placeholder="Example: https://chumgames.cc/Games/halloween-basketball/index.html">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" id="summernote"  cols="10" rows="5" class="form-control">{{$game->description}}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <select name="status" id="" class="form-select">
                                        ...
                                        <option value="1" @if($game->status == 'status') selected @endif >Publish</option>
                                        <option value="2" @if($game->status == 'status') selected @endif >Draft/Unpublished</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-12">

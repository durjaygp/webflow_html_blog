                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="name" class="form-control" id="blog_title" placeholder="Project Title" value="{{ $project->name }}" required>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="mb-4">
                                    <label for="blog_title" class="form-label fw-semibold">Small Title</label>
                                    <input type="text" name="small_title" class="form-control" id="small_title" placeholder="Small Title" value="{{ $project->small_title }}" >
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="exampleInputPassword1" class="form-label fw-semibold">Short Sub Heading</label>
                                    <textarea name="sub_heading" id="editor" class="form-control" placeholder="Short Sub Heading" required>{{ $project->sub_heading }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <img src="{{asset($project->image)}}" alt="" class="w-25 img-fluid">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="exampleInputPassword1" class="form-label fw-semibold">Main Project Content</label>
                                    <textarea name="description" id="summernote" cols="30" rows="10" required>{{ $project->description }}</textarea>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <select name="status" id="" class="form-select" required="">
                                        <option value="1" @selected(old('status', 1) == $project->status)>Publish</option>
                                        <option value="2" @selected(old('status', 2) == $project->status)>Draft/Unpublished</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <select name="position" id="" class="form-select" required="">
                                        <option value="1" @selected(old('position', 1) ==  $project->position)>Completed</option>
                                        <option value="2" @selected(old('position', 2) ==  $project->position)>In Progress</option>
                                        <option value="3" @selected(old('position', 3) ==  $project->position)>Future</option>
                                    </select>
                                </div>
                            </div>
                            <hr>
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="seo_description" class="form-control" id="exampleInputtext" placeholder="seo description" value="{{ $project->seo_description }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="seo_tags" class="form-control" id="exampleInputtext" placeholder="seo_tags" value="{{ $project->seo_tags }}">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="seo_keywords" class="form-control" id="exampleInputtext" placeholder="seo keywords" value="{{ $project->seo_keywords }}">
                                </div>
                            </div>
                            <div class="col-12">
